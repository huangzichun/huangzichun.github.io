...
1. 遇到hadoop compress方面的bug，就考虑是否指定了``hadoop/lib/native``。
...
public class CheckProcess implements Runnable {
    ...
    public CheckProcess(ApplicationId applicationId,Client client) {
    ...
    public void run() {
        ...
        //Tuple2<YarnApplicationState, FinalApplicationStatus> reports = null;
        while (true) {
            try {
            ...
            try {
                //reports = client.monitorApplication(appId, true, true);
            ...
            //FinalApplicationStatus finalState = reports._2();
            ...
            if ( state == YarnApplicationState.RUNNING) {
                if(count<99){
                    ...
                    Utils.updateAppStatus(appId.toString(), "99%" );
                }
            }
        }
    }
